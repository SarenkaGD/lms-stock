...
$receivenotelist = $LMSST->ReceiveNoteList($o, $pagelimit, $page, $sprn, (isset($filter['cid']) ? $filter['cid'] : NULL), (isset($filter['stckrnn']) ? $filter['stckrnn'] : NULL), (isset($filter['days']) ? $filter['days'] : NULL));
